    ...
    public partial class frmSetRoomAssets : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (RoomAssetID == -1)
            {
                if (Istrue == true)
                {
                    RoomAsset.SetRoomAsset(cmbPartNumber.SelectedIndex + 1, long.Parse(txtAssetNumber.Text), cmbStatus.SelectedIndex, UserID);
            ...
            else
            {
                if (Istrue == true)
                {
                    ...
                    {
                        RoomAsset.EditRoomAsset(RoomAssetID, cmbPartNumber.SelectedIndex + 1, long.Parse(txtAssetNumber.Text), cmbStatus.SelectedIndex, UserID);
        ...
        private void frmSetRoomAssets_Load(object sender, EventArgs e)
        {
            ...
            {
                txtAssetNumber.Text = TimeSerial();
            }
        }
    }
}
